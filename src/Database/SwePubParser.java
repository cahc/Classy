...
/**
 * Created by Cristian on 2016-09-30.
 */
public class SwePubParser {
        ...
        while (true) {
            ...
            if (isStart && event.asStartElement().getName().getLocalPart().equals("affiliation")) {
                ...
                if(attribute == null) {
                    ...
                    //todo ignore kb.se?
                     if(!"blah.se".equals( attribute.getValue())) {affils.add(r.getElementText().toLowerCase()); depth--; }
    ...
    public static void parse(String xmlFile, FileHashDB db) throws IOException, XMLStreamException { //indexed
        ...
        while (xmler.hasNext()) {
            XMLEvent xmle = xmler.nextEvent();
                   ...
                   if(xmle.getEventType() == XMLEvent.START_ELEMENT && xmle.asStartElement().getName().getLocalPart().equals("metadata")) {
                        depth = 0;
                        docs++;
                       Record record = new Record();
                        ...
                        while(true) { //loop until end of record
                            ...
                            //TITLE: titleInfo, level 2

                            if(isStart && xmle.asStartElement().getName().getLocalPart().equals("titleInfo") && depth == 2) {
                            ...
                            //HSV + KEYWORDS: subject
                                ...
                                if( (attribute != null) && ( "uka.se".equals(attribute.getValue()) || "hsv".equals(attribute.getValue() ) )) {
                                    ...
                                    if(keyword.contains(";")) {
                                        ...
                                        for(String s : splitted) record.addUnkontrolledKkeywords(prefixFromKeyWords.concat(s.trim()) );
                            ...
                            if(isStart && xmle.asStartElement().getName().getLocalPart().equals("genre")) {
                                ...
                                if(attribute1 != null && attribute2 != null) {
                                    ...
                                    if( type1.equals("contentType") && type2.equals("svep")) {
                                        record.addContentType( xmler.getElementText() );
                                        depth--;
                                        continue;
                                    }
                            ...
                            if(isEnd && xmle.asEndElement().getName().getLocalPart().equals("metadata") ) {
