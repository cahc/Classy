...
abstract public class ModelSearch implements Classifier, Regressor
{
     ...
     * parallelsm will be obtained by training the model using the {@link TrainAndPredict#trainC(jsat.classifiers.ClassificationDataSet, java.util.concurrent.ExecutorService)
