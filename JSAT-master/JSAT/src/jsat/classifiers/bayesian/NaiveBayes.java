...
//            }
    ...
    /**
     * Returns <tt>true</tt> if the TrainAndPredict assumes that data points are sparce.
     * @return <tt>true</tt> if the TrainAndPredict assumes that data points are sparce.
