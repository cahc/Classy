...
public class RandomForest implements Classifier, Regressor, Parameterized
{
    ...
    public CategoricalResults classify(DataPoint data)
    {
        if(forest == null || forest.isEmpty())
            throw new RuntimeException("TrainAndPredict has not yet been trained");
        else if(predicting == null)
            throw new RuntimeException("TrainAndPredict has been trained for regression");
    ...
    public double regress(DataPoint data)
    {
        if(forest == null || forest.isEmpty())
            ...
            throw new RuntimeException("TrainAndPredict has been trained for classification");
