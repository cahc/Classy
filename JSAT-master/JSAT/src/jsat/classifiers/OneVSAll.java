...
public class OneVSAll implements Classifier, Parameterized
{
     ...
     * {@link TrainAndPredict#trainC(jsat.classifiers.ClassificationDataSet, java.util.concurrent.ExecutorService) } method.
     * @see #setConcurrentTraining(boolean) 
     */
     ...
     * calling the {@link TrainAndPredict#trainC(jsat.classifiers.ClassificationDataSet, java.util.concurrent.ExecutorService) }
